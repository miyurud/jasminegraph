...
from neo4j_graphrag.llm import OllamaLLM  # Use OllamaLLM here

# === CONFIG ===
NEO4J_URI = "bolt://localhost:7687"
NEO4J_USERNAME = "neo4j"
NEO4J_PASSWORD = ""
OLLAMA_MODEL = "llama3"  # Replace with your Ollama model name if different

# === Connect to Neo4j ===
driver = GraphDatabase.driver(NEO4J_URI, auth=(NEO4J_USERNAME, NEO4J_PASSWORD))

# === (Optional) Extract Schema from Neo4j ===
...
# === Set up Text-to-Cypher Retriever with Schema ===
...
query_text = "where is Radio City?"  # Fix typo as needed
