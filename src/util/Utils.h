...
class Utils {
    ...
    public:
        ...
        static void updateSLAInformation(PerformanceSQLiteDBInterface* perfSqlite, std::string graphId,
                                         int partitionCount, long newSlaValue, std::string command,
                                         std::string category);
        ...
        static bool sendSbsQueryPlanToWorker(std::string host, int port, std::string masterIP, int graphID,
        ...
        static std::optional<std::tuple<std::string, int, int>> getWorker(string partitionID, std::string host,
                                                                          int port);
        static bool sendDataFromWorkerToWorker(string masterIP, int graphID, string partitionId, std::string message,
                                               SharedBuffer& sharedBuffer);
        bool sendPartitionMetadata(int sockfd, int partitionId, int graphId, int localVertexCount,
                                   int centralVertexCount, int edgeCount, int centralEdgeCount);
