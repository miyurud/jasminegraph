...
struct AttributeStoreBuilder {
    ...
    explicit AttributeStoreBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline flatbuffers::Offset<AttributeStore> CreateAttributeStoreDirect(
    ...
    return JasmineGraph::AttributeStore::CreateAttributeStore(_fbb, entries__);
}
...
struct AttributeStoreEntry FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    bool KeyCompareLessThan(const AttributeStoreEntry *o) const { return key() < o->key(); }
    ...
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyField<int64_t>(verifier, VT_KEY) &&
               VerifyOffset(verifier, VT_VALUE) && verifier.VerifyVector(value()) &&
...
struct AttributeStoreEntryBuilder {
    flatbuffers::FlatBufferBuilder &fbb_;
    flatbuffers::uoffset_t start_;
    void add_key(int64_t key) { fbb_.AddElement<int64_t>(AttributeStoreEntry::VT_KEY, key, 0); }
    ...
    explicit AttributeStoreEntryBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
...
inline flatbuffers::Offset<AttributeStoreEntry> CreateAttributeStoreEntryDirect(
    ...
    return JasmineGraph::AttributeStore::CreateAttributeStoreEntry(_fbb, key, value__);
}
...
inline bool VerifyAttributeStoreBuffer(flatbuffers::Verifier &verifier) {
    return verifier.VerifyBuffer<JasmineGraph::AttributeStore::AttributeStore>(nullptr);
}

inline bool VerifySizePrefixedAttributeStoreBuffer(flatbuffers::Verifier &verifier) {
    return verifier.VerifySizePrefixedBuffer<JasmineGraph::AttributeStore::AttributeStore>(nullptr);
}

inline void FinishAttributeStoreBuffer(flatbuffers::FlatBufferBuilder &fbb,
                                       flatbuffers::Offset<JasmineGraph::AttributeStore::AttributeStore> root) {
    fbb.Finish(root);
}

inline void FinishSizePrefixedAttributeStoreBuffer(
    flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<JasmineGraph::AttributeStore::AttributeStore> root) {
