...
int Conts::JASMINEGRAPH_UI_FRONTEND_PORT = 8776;
int Conts::JASMINEGRAPH_FRONTEND_PORT = 8777;
int Conts::JASMINEGRAPH_BACKEND_PORT = 8778;
int Conts::JASMINEGRAPH_VERTEXCOUNTER_PORT = 8779;
int Conts::JASMINEGRAPH_INSTANCE_PORT = 8780;       // Worker port
int Conts::JASMINEGRAPH_INSTANCE_DATA_PORT = 8781;  // Data Port
