...
class Conts {
 public:
    ...
    std::string JASMINEGRAPH_SERVER_PRIVATE_HOSTS_FILE = "machines.txt";static const int SEMANTIC_LOWER_THRESHOLD;static const int TIME_ELAPSED_LOWER_BOUND_SECONDS;static const int TOP_RELEVANT_INFORMATION_COUNT;
