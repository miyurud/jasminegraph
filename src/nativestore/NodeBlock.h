...
class NodeBlock {
 ...
 public:
    static const unsigned long BLOCK_SIZE = 140;  // Size of a node block in bytes
    static const unsigned int LABEL_SIZE = 118;    // Size of a node label in bytes
    unsigned int addr = 0;
    ...
    unsigned int metaPropRef = 0;         // Meta properties DB block address for node meta properties
    ...
    void addMetaProperty(std::string, const char *);
