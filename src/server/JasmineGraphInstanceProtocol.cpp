...
const string JasmineGraphInstanceProtocol::COLLECT_BUCKETS_TO_MASTER = "collect-buckets-to-master";
const string JasmineGraphInstanceProtocol::COLLECT_BUCKETS_TO_COORDINATOR = "collect-buckets-to-coordinator";
const string JasmineGraphInstanceProtocol::SEND_CLUSTERING_INSTRUCTIONS = "send-clustering-instructions";
const string JasmineGraphInstanceProtocol::SHARE_CLUSTER_FILES = "share-cluster-files";
const string JasmineGraphInstanceProtocol::DISTRUBUTE_SHARED_CLUSTERS = "distribute-shared-clusters";
const string JasmineGraphInstanceProtocol::COLLECT_SHARED_CLUSTERS = "collect-shared-clusters";
...
const string JasmineGraphInstanceProtocol::COLLECT_RESULTS_TO_MASTER = "collect-results-to-master";
const string JasmineGraphInstanceProtocol::COLLECT_RESULTS_TO_COORDINATOR = "collect-results-to-coordinator";
