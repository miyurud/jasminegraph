...
const string JasmineGraphInstanceProtocol::GRAPH_STREAM_STOP = "stream-stop";
const string JasmineGraphInstanceProtocol::GRAPH_STREAM_STOP_ACK = "stream-stop-ack";
