...
const string JasmineGraphInstanceProtocol::HISTORY_PAGERANK = "hpgr";
...
const string JasmineGraphInstanceProtocol::WORKER_DIRECT_KAFKA_STREAM     = "worker-direct-kafka-stream";
const string JasmineGraphInstanceProtocol::WORKER_DIRECT_KAFKA_STREAM_ACK = "worker-direct-kafka-stream-ack";
const string JasmineGraphInstanceProtocol::WORKER_DIRECT_KAFKA_DONE       = "worker-direct-kafka-done";
const string JasmineGraphInstanceProtocol::GRAPH_STREAM_BATCH_START = "batch-stream-start";
const string JasmineGraphInstanceProtocol::GRAPH_STREAM_BATCH_START_ACK = "batch-stream-start-ack";
