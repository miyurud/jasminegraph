...
const string JasmineGraphInstanceProtocol::COLLECT_CLUSTERS_TO_MASTER = "collect-clusters-to-master";
const string JasmineGraphInstanceProtocol::SHARE_BUCKETED_CLUSTERS = "share-bucketed-clusters";
const string JasmineGraphInstanceProtocol::COMPUTE_CANDIDATE_SETS = "bucket-local-clusters1";
