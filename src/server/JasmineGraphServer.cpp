        ...
        for (int i = 0; i < workerPortsVector.size(); i++) {
            ...
            if (masterHost == host || host == "localhost") {
                if (is_testing) {
                    ...
                    serverStartScript =
                        "DOCKER_API_VERSION=1.43 docker run -v " + instanceDataFolder + ":" + instanceDataFolder + " -v " +
                ...
                if (is_testing) {
                    ...
                    serverStartScript =
                        "DOCKER_API_VERSION=1.43 docker -H ssh://" + host + " run -v " + instanceDataFolder + ":" + instanceDataFolder +
